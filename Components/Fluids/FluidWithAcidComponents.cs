...
{
    public sealed class FluidWithAcidComponents : Fluid
    {
		/// <summary>
		...
		public FluidWithAcidComponents(List<FluidComponent> components) : base(components)
		 {
            foreach (FluidComponent c in components)
            {
